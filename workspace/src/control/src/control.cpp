...
class ControlNode : public rclcpp::Node
{
	public:
		...
		ControlNode(): Node("control")
		{
			...
			// Subscribers
            // ERRO sub_person_velocity = this->create_subscription<geometry_msgs::msg::Twist>(param_sub_velocity, 1, std::bind(&ControlNode::personVelocitySubCallback, this, _1));
			...
			// ERRO sub_waypoint = this->create_subscription<geometry_msgs::msg::PointStamped>(param_sub_waypoint, 1, std::bind(&ControlNode::waypointSubCallback, this, _1));
			// ERRO sub_odom = this->create_subscription<nav_msgs::msg::Odometry>(param_sub_odom, 1, std::bind(&ControlNode::odomSubCallback, this, _1));
			...
			// ERRO pub_velocity = this->create_publisher<geometry_msgs::msg::Twist>(param_pub_velocity, 10);
		}
